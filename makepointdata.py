...
parser.add_option("--nodomain", dest="nodomain", default=False, \
                     action='store_true', help='Do not make domain file')
parser.add_option("--nosurfdata", dest="nosurfdata", default=False, \
                     action='store_true', help='Do not make surfdata file')
